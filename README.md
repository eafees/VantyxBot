...
VantyxBot is a powerful Discord bot designed to help you manage your Discord server. It works with a clear web dashboard where you can control settings easily. It comes with tools for moderation, adding fun with leveling and XP, handling support tickets, and it supports both Arabic and English languages. You do not need technical skills to use it.
...
- A modern browser like Chrome, Edge, or Firefox for the web dashboard
- Internet connection to allow the bot to connect to Discord
- Discord account and proper permissions to add a bot to your server
...
## 🚀 Installing and Running VantyxBot on Windows
...
6. **Configure Using Web Dashboard**  
   Your bot has a web-based control panel where you can change settings like moderation rules, XP levels, ticket management, and language preferences. Use a supported browser and follow the simple on-screen menus.
...
- **Moderation**  
  Automatically manage bad behavior. Set rules to warn, mute, or ban users if needed.

- **XP and Leveling**  
  Reward active users with experience points and levels to encourage participation.

- **Ticketing System**  
  Let users create and track support requests inside Discord.

- **Multilingual Support**  
  Switch between Arabic and English easily through the dashboard.

- **Giveaways**  
  Run contests and giveaways automatically in your server.

- **Easy Dashboard**  
  Manage all features from a clear web interface without using commands.
...
- Your Discord account must have permission to add bots to your server.

- If the dashboard does not load, confirm your browser is up to date and not blocking scripts.

- Revisit the GitHub page for updates or bug fixes.
...
## 🔄 How to Update VantyxBot

To keep VantyxBot running well:

1. Visit the GitHub page regularly for newer releases.  
...
- Your Discord bot token (found in Discord Developer Portal)  
- Prefix for bot commands (like `!` or `$`)  
- Language setting (`"en"` for English or `"ar"` for Arabic)  
- Settings for moderation and XP features  

If you prefer, you can adjust most settings later via the web dashboard.
...
- Check the GitHub issues page for similar questions  
- Use the Discord server link found on the GitHub page to talk with community members  
